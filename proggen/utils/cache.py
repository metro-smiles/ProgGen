...
# Meta-Class for any CachedSystem. To use it, inherit it and then
    # provide cache_path in the __init__ function and set stochastic=True if necessary
    # overwrite _action with the concrete computation whose results are to be cached;
    # overwrite _cache_id that transforms args and kwargs to ID as strings (For example, arg0_value2id(_canonical_value(args[0]))[:8]).
class _CacheSystem:
